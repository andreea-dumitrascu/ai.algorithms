...
def dotGeneration(zones, file):
    for i in range(10000):
        zoneNumber = np.random.randint(0,3)
...
# definim cele 5 zone
firstZone = Zone(200, -50 , 3, 5)
secondZone = Zone(200, 200, 10, 10)
thirdZone = Zone(-100, -100, 20, 20)
...
zones=[firstZone, secondZone, thirdZone]
# generam puncte pentru 3 zone
dotGeneration(zones, f)
